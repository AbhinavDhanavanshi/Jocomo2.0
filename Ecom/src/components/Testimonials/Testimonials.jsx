                ...
                <div className="container px-5 py-10 mx-auto">
                    ...
                    <div className="flex flex-wrap -m-4">
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center group"> {/* Added group to enable hover effect */}
                                ...
                                <span className="inline-block h-1 w-10 rounded bg-blue-500 mt-6 mb-4 transition-all duration-300 transform group-hover:w-full" /> {/* Added group-hover to grow full width */}
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center group"> {/* Added group to enable hover effect */}
                                ...
                                <h2 style={{color: mode === 'dark' ? '#3B82F6' : ''}} className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">React Js</h2>
