                ...
                <div className="container px-2 py-10 mx-auto text-center">
                    ...
                    <Slider {...settings}>
                        <div className="flex flex-col items-center" style={{ width: '300px' }}>
                            <div className="h-full text-center group">
                                ...
                                <p style={{ color: mode === 'dark' ? 'white' : '' }} className="leading-relaxed">
                                    I have been using this platform for a while now and I am very happy with the service. The platform is very easy to use and user-friendly. My experience with this platform has been great. I would recommend this platform to my friends.
                                </p>
