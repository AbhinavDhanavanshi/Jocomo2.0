        ...
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0 ">
          <div className="rounded-lg md:w-2/3 ">
            {cartItems.map((item, index) => {
              const { id, title, price, description, category, imageUrl } = item;
                ...
                <div key={id} className="justify-between mb-6 rounded-lg border drop-shadow-xl bg-white p-6 sm:flex sm:justify-start" style={{ backgroundColor: mode === 'dark' ? 'rgb(32 33 34)' : '', color: mode === 'dark' ? 'white' : '', }}>
                  ...
                  <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                    <div className="mt-5 sm:mt-0">
                      ...
                      {ownerDetail && (
                        <div className="mt-2">
                          <p className="text-xs font-semibold text-gray-700" style={{ color: mode === 'dark' ? 'white' : '' }}>
                    ...
                    <div onClick={() => deleteCart(item)} className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6 hover:cursor-pointer">
          ...
          <div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3" style={{ backgroundColor: mode === 'dark' ? 'rgb(32 33 34)' : '', color: mode === 'dark' ? 'white' : '', }}>
            <div className="mb-2 flex justify-between">
              <p className="text-gray-700" style={{ color: mode === 'dark' ? 'white' : '' }}>Total Amount</p>
              <p className="text-gray-700" style={{ color: mode === 'dark' ? 'white' : '' }}>₹{totalAmount}</p>
            </div>
            <div className="mb-2 flex justify-between">
              <p className="text-gray-700" style={{ color: mode === 'dark' ? 'white' : '' }}>Reveal Charges</p>
              <p className="text-gray-700" style={{ color: mode === 'dark' ? 'white' : '' }}>FREE</p>
              {/* <p className="text-gray-700" style={{ color: mode === 'dark' ? 'white' : '' }}>₹{Reveal}</p> */}
            </div>
            <hr className="border border-gray-300" />
            <div className="mt-2 flex justify-between">
              <p className="font-bold text-gray-700" style={{ color: mode === 'dark' ? 'white' : '' }}>Grand Total</p>
              <p className="font-bold text-gray-700" style={{ color: mode === 'dark' ? 'white' : '' }}>₹{totalAmount}</p>
            </div>
